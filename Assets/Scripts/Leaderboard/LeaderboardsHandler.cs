...
namespace Leaderboard
{
    public class LeaderboardsHandler : MonoBehaviour
    {
        ...
        public void Initialize(GamePlayService gamePlayService, AchievementSystem achievementSystem)
        {
            ...
            _highscoreDistanceLeaderboard = CreateLeaderboard(
                _highscoreDistanceLeaderboardView,
                HighscoreDistanceBoard);
        ...
        public void Enable()
        {
            ...
            else
            {
                ...
                GameAnalytics.NewDesignEvent("guiClick:Leaderboard:NotAuthorized");
            }
        }
        ...
        private void SavePlayerScoreToLeaderboard(LeaderboardYandex leaderboard, int score) =>
            leaderboard.SetScore(score);

        private void InstantiateLeaderboardView(LeaderboardView leaderboardView) =>
            leaderboardView.InstantiateLeaderboardElements(_numberTopPlayers);
