...
namespace Core.Cameras
{
    public class CameraSwitch : MonoBehaviour
    {
            ...
            InteractionHandler interactionHandler)
        {
            if (_isInitialized)
                throw new InvalidOperationException(
                    $"{GetType()}: Initialize(GameStateService gameStateService, GamePlayService gamePlayService, InteractionHandler interactionHandler): Already initialized.");
        ...
        {
            _finishCamera.m_Lens.FieldOfView = Mathf.Lerp(
                _finishCamera.m_Lens.FieldOfView,
                MinimumFieldOfView,
                InterpolateValueFieldOfView);
        ...
        private void ChangeFieldOfViewForGameCamera()
        {
            ...
            float newFieldOfView = Mathf.Clamp(
                _gameCamera.m_Lens.FieldOfView - NarrowingOfFieldOfView,
                MinimumFieldOfView,
                _gameCamera.m_Lens.FieldOfView);

            _gameCamera.m_Lens.FieldOfView = newFieldOfView;
        }

        private void SwitchCamers(
            CinemachineVirtualCameraBase cameraToDisable,
            CinemachineVirtualCameraBase cameraToEnable)
        {
        ...
        private void SwitchCamers(
            CinemachineVirtualCameraBase cameraOneToDisable,
            CinemachineVirtualCameraBase cameraTwoToDisable,
            CinemachineVirtualCameraBase cameraToEnable)
        {
        ...
        private void SetFollow(CinemachineVirtualCameraBase camera, Car.Car car) => camera.Follow = car.transform;

        private void SetLookAt(CinemachineVirtualCameraBase camera, Car.Car car) => camera.LookAt = car.transform;
        ...
        private void OnTriggeredCar(Car.Car car)
        {
